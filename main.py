...
print("Tip: Copy and paste the file location and hash.")
print("Please do not type quotation marks.")
file = input("Please enter the file path: ")
print("Please do not type sha256: before the hash.")
expectedsha256 = input("Please enter the expected SHA-256 hash: ").lower()
print("If there's no MD5, you can leave this box blank.")
expectedmd5 = input("Please enter the expected MD5 hash: ").lower()
